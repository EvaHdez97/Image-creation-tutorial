...
```
sudo singularity build <singularity_image_name>.sif docker://<docker_image_name>:<tag>
```
Example:
```
sudo singularity build dtc-v2-test_meteo-gfs-test_linuxamd64_zen3_nompi_nogpu_version_v2.sif docker://evahdez/dtc-v2-test_meteo-gfs_test_linuxamd64_zen3_nompi_nogpu:version_v2
